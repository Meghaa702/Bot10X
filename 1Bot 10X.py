...
if api_key is None or api_key == "":
    ...
    st.set_page_config(page_title='Bot 10X by BINARY BUDDIES', page_icon='💟')

    st.title("Bot 10X by BINARY BUDDIES")
    st.markdown(" An all-in-one Solution for Streamlined Interactions and Information Access")
    new_use_image_chat = st.checkbox("Use vision 🖼")
